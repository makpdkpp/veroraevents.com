...
?>
<?php adminShellStart('posts', $isNew ? 'บทความใหม่' : 'แก้ไขบทความ') ?>
<section class="admin-page stack-lg">
  <?php adminPageHeader(
      'Editorial',
      $isNew ? 'เขียนบทความใหม่' : 'แก้ไขบทความ',
      'เขียนคอนเทนต์หลัก กำหนด slug ภาพประกอบ และตั้งค่า social intent จากหน้าจอเดียว',
      '<a href="/admin/dashboard.php" class="btn btn-ghost">กลับรายการบทความ</a>'
  ) ?>

    <form method="POST" action="/admin/save.php" class="stack-lg">
