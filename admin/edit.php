...
$isNew    = true;
$file     = '';
$data     = ['title' => '', 'slug' => '', 'date' => date('Y-m-d'), 'description' => '', 'image' => '', 'post_facebook' => true, 'post_instagram' => true];
$body     = '';
  ...
  <div class="card">
    ...
    <form method="POST" action="/admin/save.php">
      ...
      <div class="field-row">
        ...
        <label>
          <span>URL รูปภาพหลัก <small style="font-weight:400;text-transform:none">(ต้องการสำหรับ Instagram)</small></span>
