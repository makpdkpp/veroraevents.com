...
.box{width:min(100%,440px);padding:1.25rem}
.card{background:rgba(255,252,250,.88);border:1px solid rgba(255,255,255,.82);border-top-color:rgba(255,255,255,.96);box-shadow:0 20px 60px rgba(120,77,86,.12);backdrop-filter:blur(20px);border-radius:32px;padding:2.5rem 2rem}
.eyebrow{display:inline-flex;align-items:center;justify-content:center;width:100%;margin-bottom:1rem;font-size:.76rem;font-weight:700;color:#b8883e;letter-spacing:.16em;text-transform:uppercase}
.logo{display:flex;align-items:center;gap:.75rem;justify-content:center;margin-bottom:1rem}
.logo img{width:2.8rem;height:2.8rem}
...
h2{text-align:center;font-size:1.4rem;font-weight:600;margin-bottom:.5rem}
.lede{text-align:center;color:#725861;font-size:.92rem;line-height:1.7;margin-bottom:1.5rem}
...
.btn{width:100%;padding:.85rem;border-radius:999px;border:none;background:linear-gradient(135deg,#d9849d,#c79c63);color:#fff;font-family:inherit;font-size:.97rem;font-weight:600;cursor:pointer;margin-top:.5rem;box-shadow:0 10px 28px rgba(180,100,120,.24);transition:transform 180ms,opacity 180ms}
...
.note{margin-top:1rem;padding-top:1rem;border-top:1px solid rgba(185,137,103,.16);font-size:.82rem;color:#725861;line-height:1.7}
</style>
</head>
<body>
<div class="box">
  <div class="card">
    <div class="eyebrow">Verora CMS</div>
    <div class="logo">
    ...
    <h2>เข้าสู่ระบบ</h2>
    <p class="lede">จัดการบทความ หน้าเว็บไซต์ แกลเลอรี และงานเผยแพร่จากศูนย์กลางเดียว</p>
    <?php if ($error): ?>
    ...
    <div class="note">
      ใช้บัญชีผู้ดูแลจาก <code>admin/config.php</code> หากมีการล็อกชั่วคราวจากการลองผิดหลายครั้ง ให้รอครบเวลาตามที่ระบบแจ้งก่อน
    </div>
  </div>
</div>
</body>
